...
namespace solvent::lib::gen::path {
	...
	private:
		...
		static consteval grid_cache_t init_map_prog_to_coord_() noexcept {
			...
			else if constexpr (PK == E::BlockCol) {
				ord4i_t i = 0;
			...
			else if constexpr (PK == E::DealRwMj) {
				ord4i_t i = 0;
	...
	#define M_SOLVENT_TEMPL_TEMPL(O_) \
		template struct PathCoords_<E::RowMajor, O_>; \
		template struct PathCoords_<E::BlockCol, O_>; \
		template struct PathCoords_<E::DealRwMj, O_>;
	...
	coord_converter_t<O> get_prog_to_coord_converter(const E path_kind) noexcept {
		switch (path_kind) {
		case E::RowMajor: return PathCoords_<E::RowMajor, O>::prog_to_coord;
		case E::BlockCol: return PathCoords_<E::BlockCol, O>::prog_to_coord;
		case E::DealRwMj: return PathCoords_<E::DealRwMj, O>::prog_to_coord;
		default: return PathCoords_<E::RowMajor, O>::prog_to_coord; // never
		}
	}
	...
	coord_converter_t<O> get_coord_to_prog_converter(const E path_kind) noexcept {
		switch (path_kind) {
		case E::RowMajor: return PathCoords_<E::RowMajor, O>::coord_to_prog;
		case E::BlockCol: return PathCoords_<E::BlockCol, O>::coord_to_prog;
		case E::DealRwMj: return PathCoords_<E::DealRwMj, O>::coord_to_prog;
		default: return PathCoords_<E::RowMajor, O>::coord_to_prog; // never
		}
	}
