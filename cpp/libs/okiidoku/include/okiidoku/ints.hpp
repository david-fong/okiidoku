...
namespace okiidoku {
	...
	public:
		...
		[[gnu::const]] constexpr operator detail::uint_fast_for_max_t<max>(this Int self) noexcept { self.check(); return detail::uint_fast_for_max_t<max>{self.val_}; }
	...
	namespace detail {
		...
		consteval void accept_int_wrapper(Int<max_, kind_>) {}
