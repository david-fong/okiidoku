...
namespace solvent::gen::bt {
	...
	namespace cell_dead_ends {
		...
		constexpr unsigned long long limit_default[]{ 0, 0, 3,
			...
			/*8*/10'000'000'000ull, // <- not tested AT ALL ...
			/*9*/10'000'000'000ull, // <- not tested AT ALL ...
			/*10*/10'000'000'000ull, // <- not tested AT ALL ...
			/*11*/10'000'000'000ull, // <- not tested AT ALL ...
			/*12*/10'000'000'000ull // <- not tested AT ALL ...
		};
		...
		constexpr unsigned long long limit_i_max[]{ 0, 0, 3,
			...
			/*8*/1'000'000'000'000ull, // <- not tested AT ALL ...
			/*9*/1'000'000'000'000ull, // <- not tested AT ALL ...
			/*10*/1'000'000'000'000ull, // <- not tested AT ALL ...
			/*11*/1'000'000'000'000ull, // <- not tested AT ALL ...
			/*12*/1'000'000'000'000ull // <- not tested AT ALL ...
		};
		template<Order O>
