...
function(okiidoku_enable_profile_guided_optimization
	...
	ExternalProject_Add("$${training_proj}"
		...
		CMAKE_ARGS ""
		CMAKE_CACHE_ARGS
			"-DCMAKE_INSTALL_PREFIX:PATH=${PROJECT_BINARY_DIR}/_deps/${PROJECT_NAME}_pgo-install"
			"-DCMAKE_CONFIGURATION_TYPES:STRING=PgoGen"
			"-DCMAKE_BUILD_TYPE:STRING=PgoGen"
			"-DOKIIDOKU_BUILD_TESTING:BOOL=NO"
			"-DOKIIDOKU_BUILD_SHARED:BOOL=${OKIIDOKU_BUILD_SHARED_LIBS}"
