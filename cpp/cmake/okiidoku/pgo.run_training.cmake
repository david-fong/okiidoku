...
if(NOT EXISTS "${trainee_binary}")
	message(FATAL_ERROR "trainee binary was not found: '${trainee_binary}'")
endif()
if(NOT EXISTS "${trainer_binary}")
	message(FATAL_ERROR "trainer binary was not found: '${trainer_binary}'")
endif()
if(
	...
	message(STATUS " no need to retrain")
